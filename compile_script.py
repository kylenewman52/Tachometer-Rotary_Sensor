...
# SAMPLE: compile_script.py level_of_compilation comXX
# Example: ./compile_script.py 4 com12
print ("Number of arguments: %d" %  len(sys.argv))
print ("Argument List: %s" % str(sys.argv))

files_to_compile = ['rotary_sensor', 'lcd_lib\hd44780']
file_to_compile = 'rotary_sensor'
if len(sys.argv) == 2:
    com_port = 'com12'
else:
	com_port = sys.argv[2]
